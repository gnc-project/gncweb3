...
var Subscriptions = require('gncweb3-core-subscriptions').subscriptions;
var Method = require('gncweb3-core-method');
var utils = require('gncweb3-utils');
var Net = require('gncweb3-net');

var ENS = require('gncweb3-eth-ens');
var Personal = require('gncweb3-eth-personal');
var BaseContract = require('gncweb3-eth-contract');
var Iban = require('gncweb3-eth-iban');
var Accounts = require('gncweb3-eth-accounts');
var abi = require('gncweb3-eth-abi');
...
var Eth = function Eth() {
    ...
    // gncweb3-eth would subsequently change the provider for _all_ contract
    // instances!
    var self = this;
    ...
    // make our proxy Contract inherit from gncweb3-eth-contract so that it has all
        ...
        new Subscriptions({
            ...
            subscriptions: {
                ...
                'logs': {
                    ...
                    inputFormatter: [formatter.inputLogFormatter],
                    outputFormatter: formatter.outputLogFormatter,
                    // DUBLICATE, also in gncweb3-eth-contract
