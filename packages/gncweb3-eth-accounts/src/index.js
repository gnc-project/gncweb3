...
var core = require('gncweb3-core');
var Method = require('gncweb3-core-method');
var Account = require('gnc-lib/lib/account');
var Hash = require('gnc-lib/lib/hash');
var RLP = require('gnc-lib/lib/rlp');// jshint ignore:line
var Bytes = require('gnc-lib/lib/bytes');// jshint ignore:line
var cryp = (typeof global === 'undefined') ? require('crypto-browserify') : require('crypto');
var scrypt = require('scrypt-js');
var uuid = require('uuid');
var utils = require('gncweb3-utils');
var helpers = require('gncweb3-core-helpers');
var Transaction = require('ethgncjs-tx').Transaction;
var Common = require('ethgncjs-common').default;
...
Accounts.prototype.signTransaction = function signTransaction(tx, privateKey, callback) {
    ...
    function signed(tx) {
        if (tx.common && (tx.chain && tx.hardfork)) {
            error = new Error(
                'Please provide the ethgncjs-common object or the chain and hardfork property but not all together.'
            );
        }
        ...
        try {
            ...
            transaction.to = transaction.to || 'GNC';
            transaction.data = transaction.data || '0x';
            transaction.value = transaction.value || '0x';
            transaction.chainId = utils.numberToHex(transaction.chainId);
            transaction.txType = utils.numberToHex(transaction.txType);

            // Because tx has no ethgncjs-tx signing options we use fetched vals.
...
// Taken from https://github.com/ethereumjs/ethgncjs-wallet
...
Accounts.prototype.encrypt = function(privateKey, password, options) {
    ...
    return {
        ...
        address: account.address.toLowerCase().replace('GNC', ''),
        crypto: {
...
// http://web3js.readthedocs.io/en/1.0/gncweb3-eth-accounts.html
