...
import {
    ...
    JsonRpcPayload,
    JsonRpcResponse
} from 'gncweb3-core-helpers';
import { Method } from 'gncweb3-core-method';
...
// had to move `gncweb3-net` due to other modules in `1.x` not referencing
...
// had to move accounts from gncweb3-eth-accounts due to other modules in 1.x not referencing
...
// put all the `gncweb3-provider` typings in here so we can get to them everywhere as this module does not exist in 1.x
