...
*/
/**
 * @file gncweb3-provider-ws-tests.ts
 * @author Josh Stevens <joshstevens19@hotmail.co.uk>
 * @date 2018
 */

import { WebsocketProviderOptions, JsonRpcResponse } from 'gncweb3-core-helpers';
import { WebsocketProvider } from 'gncweb3-providers';
